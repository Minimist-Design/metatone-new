...
const ITEMS = [
    ...
    socials: [
      {
        ...
        link: 'https://www.instagram.com/johnsummit/',
      },
      { icon: 'custom-x', link: 'https://twitter.com/johnsummit' },
      {
        icon: 'fa-brands fa-tiktok',
        link: 'https://www.tiktok.com/@johnsummit',
      },
  ...
  },
  {
    ...
    socials: [
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/maxstyler/',
      },
      { icon: 'custom-x', link: 'https://twitter.com/maxstyler' },
      {
        icon: 'fa-brands fa-soundcloud',
        link: 'https://soundcloud.com/maxstyler',
      },
    ],
  },
  ...
  // --- ROW 2 ---
  {
    ...
    socials: [
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/rangertrucco/',
      },
      { icon: 'custom-x', link: 'https://twitter.com/djrangertrucco' },
      {
        icon: 'fa-brands fa-soundcloud',
        link: 'https://soundcloud.com/ranger-trucco',
      },
    ],
  },
  {
    ...
    socials: [
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/laytongiordani/',
      },
      { icon: 'custom-x', link: 'https://twitter.com/LaytonGiordani' },
      {
        icon: 'fa-brands fa-facebook',
        link: 'https://www.facebook.com/LaytonGiordani',
      },
      {
        icon: 'fa-brands fa-soundcloud',
        link: 'https://soundcloud.com/laytongiordani',
      },
    ],
  },
  ...
  // --- ROW 3 ---
  {
    ...
    socials: [
      ...
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/expertsonly/',
      },
      { icon: 'custom-x', link: 'https://twitter.com/expertsonly_' },
      {
        icon: 'fa-brands fa-tiktok',
        link: 'https://www.tiktok.com/@expertsonlyrecs',
      },
      {
        icon: 'fa-brands fa-facebook',
        link: 'https://www.facebook.com/expertsonlyrec',
      },
      {
        icon: 'fa-brands fa-youtube',
        link: 'https://www.youtube.com/@expertsonly',
      },
      {
        icon: 'fa-brands fa-soundcloud',
        link: 'https://soundcloud.com/expertsonly',
      },
    ],
  },
  {
    ...
    socials: [
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/range.label/',
      },
      {
        icon: 'fa-brands fa-youtube',
        link: 'https://www.youtube.com/@naturalrange',
      },
    ],
  },
  ...
  // --- ROW 4 ---
  {
    ...
    socials: [
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/numodarecords/',
      },
      { icon: 'custom-x', link: 'https://x.com/numodarecords' },
      {
        icon: 'fa-brands fa-tiktok',
        link: 'https://www.tiktok.com/@numodarecords',
      },
      {
        icon: 'fa-brands fa-facebook',
        link: 'https://www.facebook.com/numodarecords',
      },
    ],
  },
  {
    ...
    name: 'MAD MINDS',
    type: 'label',
    logo: 'https://images.squarespace-cdn.com/content/v1/61022155cc16ca349d135a60/e739fad0-da22-4505-933b-6b932b34b049/MADMINDS+COMBINED+%28HORIZONTAL%29.jpg?format=2500w',
    images: [
    ...
    socials: [
      {
        icon: 'fa-brands fa-soundcloud',
        link: 'https://soundcloud.com/madmindsnyc',
      },
      {
        icon: 'fa-brands fa-instagram',
        link: 'https://www.instagram.com/madmindsnyc/',
      },
    ...
    <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 py-4 md:px-10 md:py-6 mix-blend-exclusion text-white pointer-events-none">
      ...
      <div className="pointer-events-auto flex items-center gap-6">
        ...
        <div className="hidden sm:flex items-center gap-6 text-white">
          <a
            href="https://www.instagram.com/metatonemgmt/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[#cf0110] hover:scale-110 transition-all duration-300"
          >
            <i className="fa-brands fa-instagram text-xl"></i>
          </a>
          <a
            href="https://x.com/metatonemgmt"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[#cf0110] hover:scale-110 transition-all duration-300 flex items-center"
          >
            <XLogo />
          </a>
          <a
            href="https://www.facebook.com/metatonemgmt"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[#cf0110] hover:scale-110 transition-all duration-300"
          >
          ...
          <a
            href="https://open.spotify.com/user/bodhicollective?si=6099b68d6b1344b0"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[#cf0110] hover:scale-110 transition-all duration-300"
          >
          ...
          <a
            href="https://soundcloud.com/metatonemgmt"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[#cf0110] hover:scale-110 transition-all duration-300"
          >
...
const GridItem = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 w-full h-full p-4 md:p-8 flex items-center justify-center transition-all duration-500 ease-out group-hover:scale-[1.02] ${
    ...
    <div className="bg-[#050505] min-h-screen text-white font-sans selection:bg-[#333] selection:text-white">
      ...
      <main className="relative pt-32 pb-20 px-4 md:px-6 max-w-[1800px] mx-auto">
        ...
        <div className="mb-24 flex flex-col items-center justify-center py-10 md:py-20 min-h-[60vh]">
          ...
          >
            <span className="font-mono text-xs uppercase tracking-[0.3em] group-hover:tracking-[0.5em] transition-all duration-500">
              View Roster
            </span>
      ...
      <footer className="px-6 py-12 border-t border-white/10 mt-20 bg-black">
        <div className="max-w-[1800px] mx-auto flex flex-col items-center justify-center text-center gap-6">
          ...
          <p className="font-mono text-xs uppercase text-neutral-600 tracking-wider">
            © 2026 Metatone Management, LLC. All Rights Reserved &nbsp;●&nbsp;
            Website crafted by: Minimist
          </p>
        </div>
      </footer>
    </div>
